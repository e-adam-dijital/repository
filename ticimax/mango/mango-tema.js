...
$(document).ready(function () {
    ...
    setTimeout(function () {
        loadStyle(
            "https://fonts.googleapis.com/css?family=Poppins:400,500,600,700&display=swap&subset=latin-ext",
            function () {}
        );
    }, 500);
    //sayfaislemleri
    ...
    } //Icerik sayfasinda bodye class ekleme
    if ($(".magazalarContent").length > 0) {
        $("body").addClass("Magazalar");
    } //Magaza sayfasinda bodye class ekleme
    GlobalIslemler();
});
function GlobalIslemler() {
    //Tum ekranlar ready sahnesi
    if (!pageInitialized) {
        if (windowidth > 767) {
            /*siteozel*/
...
function KategoriIslemleri() {
    //Kategori ready sahnesi
    $(".categoryTitle .categoryTitleText").prependTo(".categoryContainer");
    if (windowidth > 1041) {
        $("body").on("click", ".leftBlock .category-vertical-filters .panel .panel-heading", function (event) {
...
function UrunDetayIslemleri() {
    ...
    if (!pageInitialized) {
        ...
        if (windowidth > 767) {
            ...
            $("body").on("click", ".basketBtn,.UFavorilerimeEkle a", function () {
                if ($("#hddnUrunID").val() == "0") {
                    $("html,body").animate({ scrollTop: $("#divUrunEkSecenek").offset().top - 110 }, "slow");
                }
            });
        }
        setTimeout(function () {
        ...
        $("body").on("click", ".FiyatHaberVer a", function () {
            setTimeout(function () {
                tooltips();
            }, 100);
        });
...
function topMenuCallback() {
    ...
    if (/* menuwidth > 1000 || */ $(".navigation .navUl > li").length > 10 || windowidth < 1340) {
        mobileMenu();
    } else {
...
function blockCompleteCallback() {
    ...
    if (globalModel.pageType == "productdetail") {
        ...
        $("body").on("click", ".mobilTab >ul>li>a", function () {
            ...
            var tabName = openTab.attr("data-tab") || "";
            if (tabName === "Commets") {
                TabGetComments();
    ...
    $(".sliderBannerContainer:not(.NoSlider) .jCarouselLite ul").each(function () {
        ...
        if ($(this).find("li").length > 0 && !$(this).hasClass("owl-carousel"))
            $(this).owlCarousel({
                ...
                lazyLoad: true,
                responsive: {
                    0: { items: 2, autoplay: false, loop: true, margin: 5 },
                    768: { items: 3 },
                    1025: { items: 3 },
                    1042: { items: 4 },
                    1200: { items: 4 },
   ...
   urunDuzeni(urunDuzeniTipi);
    ...
    if (globalModel.pageType == "productdetail") {
        ...
        $(".centerCount .detaySliderContainer:not(#divIlgiliUrunler) .jCarouselLite ul").each(function () {
            if ($(this).find("li").length > 0 && !$(this).hasClass("owl-carousel"))
                $(this).owlCarousel({
                    ...
                    lazyLoad: true,
                    responsive: {
                        0: { items: 2, autoplay: true, loop: true, margin: 5 },
                        768: { items: 3 },
                        1025: { items: 3 },
                        1042: { items: 4 },
                        1200: { items: 4 },
        ...
        if ($(".resimlivaryasyon").length > 0) {
            $(".TopDet #IlgiliUrunDiv .JKatAdi .bold .satir1").html(
                $("#divUrunEkSecenek .eksecenekLine.resimlivaryasyon .left_line").text()
            );
        }
    }
    urunDon();
...
function urunDuzeni(tip) {
    //Urun duzen tipi 2 3 4 5 veya tek
    if ($("#divSayfalamaUst").length > 0) {
        ...
        if ($(".blockSelect .sort_2").length == 0) {
            $(".blockSelect .sort_3").before(
                '<a href="javascript:;" class="sort_2"><i class="fas fa-th-large"></i></a>'
            );
        }
        ...
        if (windowidth < 1042) {
            if ($(".FiltreUst").length == 0) {
                $("body #divSayfalamaUst .category-vertical-filters.top-filters").prepend(
                    '<div class="tukgo"><a onclick="sortingClick(1000)" class="filterOrderInStock">' +
                        translateIt("Urunler_Stoktakiler") +
                        "</a></div>"
                );
                $("body #divSayfalamaUst .category-vertical-filters.top-filters").prepend(
                    '<div class="FiltreUst"><div class="closeFilt"><i class="fal fa-times"></i></div><span>' +
                        translateIt("UrunFiltreleme_Filtreleme") +
                        '</span><a onclick="clearAllFilters()"><i class="fal fa-trash-alt"></i></a></div>'
                );
                if ($(".moreNum").length == 0) {
                    $("#divSayfalamaUst .category-vertical-filters.top-filters .panel")
                        .find(".panel-heading")
                        .append('<div class="moreNum"></div>');
                }
...
function mobileMenu() {
    ...
    $("body").on("click", ".mobilMenuAcButton", function () {
        if ($(".mobilMenu").length == 0) {
            $("body").prepend(
                '<div class="mobilMenu"><div class="menuUstBolum"><div class="mobilMenuBT"><i class="fal fa-bars"></i><span>MENU</span></div><div class="CloseBtnMenu"><i class="far fa-times"></i></div></div><div class="menuIcerikAlan">' +
                    menuKopya +
                    "</div>"
            );
            if ($(".HeaderMenu2").length > 0) {
                $(".mobilMenu .HeaderMenu2 > li > ul")
                    .closest("li")
                    .append('<div class="ResimsizDown"><i class="fal fa-angle-right"></i></div>');
                $(".mobilMenu .HeaderMenu2 > li > ul li ul")
                    .closest("li")
                    .append('<div class="ResimsizDown2"><i class="fal fa-angle-right"></i></div>');
                ...
                $(".ResimsizDown").each(function (index, el) {
                    ...
                    $(this)
                        ...
                        .find("> ul")
                        .prepend(
                            '<span><div class="NoiBack"><i class="fal fa-long-arrow-left"></i></div> <span>' +
                                Down1 +
                                "</span></span>"
                        );
                });
                $(".ResimsizDown2").each(function (index, el) {
                    ...
                    $(this)
                        ...
                        .find("> ul")
                        .prepend(
                            '<span><div class="NoiBack2"><i class="fal fa-long-arrow-left"></i></div> <span>' +
                                Down2 +
                                "</span></span>"
                        );
                });
    ...
    $("body").on("click", ".product_social_icons", function () {
        if ($(this).attr("content") == "facebook") {
            if (isMobileDevice()) {
                ...
                window.open(
                    "http://www.facebook.com/sharer.php?s=100&p[medium]=100&p[title]=" +
                        $.trim(title) +
                        "&p[images][0]=" +
                        image +
                        "&p[url]=" +
                        ...
                        "",
                    "sharer",
                    "toolbar=0,status=0,width=630,height=430"
                );
            }
        } else if ($(this).attr("content") == "twitter") {
            window.open(
                "http://twitter.com/intent/tweet?text=" + $.trim(title) + "&url=" + url + "",
                "sharer",
                "toolbar=0,status=0,width=630,height=430"
            );
...
function sepetBindRefresh(res) {
    ...
    if (windowidth < 768) {
        ...
        if ($(".SepetUst").length == 0) {
            $(".CartProduct").prepend(
                '<div class="SepetUst"><div class="seClose"><i class="fal fa-times"></i></div><span>' +
                    translateIt("GlobalMasterPage_Sepetim") +
                    "</span></div>"
            );
        }
    }
...
function tooltips() {
    ...
    $(".ProductIcon > div > a").each(function (index, el) {
        if ($(this).attr("SC_toolTip") == "SC_toolTip" && $(this).find(".tooltip").length == 0) {
            ...
            $(this).append(
                '<div class="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner">' +
                    titleInner +
                    "</div></div>"
            );
            ...
            if ($(".tooltip").hasClass("right") || $(".tooltip").hasClass("left")) {
                $(this)
                    .find(".tooltip")
                    .css("margin-top", -thisheight / 2);
            }
            if ($(".tooltip").hasClass("top") || $(".tooltip").hasClass("bottom")) {
                $(this)
                    .find(".tooltip")
                    .css("margin-left", -thiswidth / 2);
            }
        }
    });
    $(".ProductIcon > div > a").mouseenter(function (event) {
        $(this).find(".tooltip").addClass("in");
    });
    $(".ProductIcon > div > a").mouseleave(function (event) {
...
function bottomHead() {
    if (!mobtmScrollCtrl && $(".bottomHead").length == 0) {
        $("body:not(.sepetimBody)").append(
            '<div class="bottomHead"> <ul> <li class="homeC"> <a href="/"><i class="fal fa-home"></i><span>' +
                translateIt("GlobalMasterPage_Anasayfa") +
                '</span></a> </li> <li class="favoC"> <a href="javascript:void(0)" onclick="GirisKontrol(0)"><i class="fal fa-heart"></i><span>' +
                translateIt("Favorilerim_Baslik") +
                '</span><div class="favNum"></div></a> </li> <li class="cartC"> <a href="/sepetim.aspx"><i class="fal fa-shopping-cart"></i><span>' +
                translateIt("GlobalMasterPage_Sepetim") +
                '</span></a> </li> <li class="welcC"> <a href="javascript:void(0)" onclick="GirisKontrol(0)"><i class="fal fa-user"></i><span>' +
                translateIt("GlobalMasterPage_MobilUyeGirisi") +
                "</span></a> </li> </ul> </div>"
        );
