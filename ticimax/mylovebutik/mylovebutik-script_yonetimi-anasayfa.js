...
(function (root, factory) {
  ...
  function () {
    ...
    Pageable.prototype._start = function (e) {
      ...
      function update(event) {
        ...
        for (let i = 0; i < event.touches.length; i++) {
          ...
          localStorage.setItem("pageX", event.touches[i]);
          localStorage.setItem("pageY", event.touches[i].clientY);
          let dot = document.createElement("dot");
          //dot.style.left = (pageX - 50) + "px";
          //dot.style.top = (pageY - 50) + "px";
          //document.body.appendChild(dot);
          //console.log(pageX, pageY,pageY.clientX,pageY.screenY);
        }
      }
      ...
      console.log(
        evt[this.mouseAxis[this.axis]],
        localStorage.getItem("pageY")
      );
      //if(this.config.swipeThreshold){
      //this._preventDefault(e);
      //}
      //console.log(evt[this.mouseAxis[this.axis]],pageY,this.config.swipeThreshold);
    ...
    Pageable.prototype._wheel = function (e) {
      e.preventDefault();
      //  && (Number(localStorage.getItem("thisOldIndex")) == this.index && (this.OldIndex < this.index || Number(localStorage.getItem("thisOldIndex")) + 1 == this.index) || Number(localStorage.getItem("thisOldIndex") - 1 == this.index))
      localStorage.setItem("firstScrollWheelPA", 0);
      var wheelEndPA = 0;
      var d = new Date();
      var n = d.getTime();
      // && (Number(localStorage.getItem("thisIndexPA")) == this.index || localStorage.getItem("firstScrollWheelPA") != 1)

       /** Mousewheel for scroll event to work on Macos computer */
      if (
        ...
        localStorage.setItem("firstScrollWheelPA", 1);
        var wheelEndPA = 1;
        setTimeout(function () {
          localStorage.setItem("firstScrollTimePA", n);
          localStorage.setItem("thisIndexPA", this.index);
        }, 100);
      } else {
            localStorage.setItem("thisIndexPA", this.index);
    ...
    $(document).ready(function () {
            ...
            var footerClone = $("#footer");
            $("#footer").remove();
            $(footerClone).clone().appendTo(".subBg_8");
        
    });
  
    $("#divIcerik").append(`<div id="containerCustom">
    <div data-anchor="Kampanya" class="scrollBg_01">
    <a href="/yenigelenler">
        <div class="subBg subBg_01"></div>
    </a>
    </div>
    <div data-anchor="yenigelenler" class="scrollBg_1">
    <a href="/yenigelenler">
        <div class="subBg subBg_0"></div>
    </a>
    </div>
    <div data-anchor="tshirt" class="scrollBg_2">
        <a href="/tshirt">
            <div class="subBg subBg_1"></div>
        </a>
    </div>
    <div data-anchor="elbiseler" class="scrollBg_3">
        <a href="/elbiseler">
            <div class="subBg subBg_2"></div>
        </a>
    </div>
    <div data-anchor="bluz" class="scrollBg_4">
        <a href="/bluz">
            <div class="subBg subBg_3"></div>
        </a>
    </div>
    <div data-anchor="" class="scrollBg_5">
        <a href="/etek">
            <div class="subBg subBg_4"></div>
        </a>
    </div>
    <div data-anchor="iletisim" class="scrollBg_8">
            <div class="subBg subBg_8"></div>
    </div>
  </div>
  `);
  ...
  $(document).ready(function () {
    ...
    $(".FooterMiddle .linkler ul > li > span").on("click", function (event) {
      $(this).next("ul").css("display") // .toggleClass("active")
      //event.preventDefault();
      
      //$(".FooterMiddle .linkler ul > li > span + ul").removeClass("active");
      
      if($(this).next("ul").hasClass("footer_active")){
        $(this).next("ul").removeClass("footer_active");
      }else{
        $(this).next("ul").addClass("footer_active");
      }
